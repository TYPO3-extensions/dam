 ...
 *
 *
 *   70: class local_extFileFunctions extends t3lib_extFileFunctions	
 *   83:     function func_upload($cmds)	
 *  181:     function writeLog($action,$error,$details_nr,$details,$data, $actionName='', $id='')	
 *
 *
 *  207: class tx_dam_tce_file 
 *  226:     function init()	
 *  261:     function initClipboard()	
 *  283:     function process()	
 *
 * TOTAL FUNCTIONS: 5
...
#TODO format
		...
		if (!($theFileSize<($this->maxUploadFileSize*1024)))	{
			$this->writelog(1,1,104,'The uploaded file exceeds the size-limit of %s bytes',Array($this->maxUploadFileSize*1024), 'upload', $id);
			return;
		}	
