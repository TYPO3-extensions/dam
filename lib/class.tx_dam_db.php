...
class tx_dam_db {
	 ...
	 * @param	array		$whereClauses WHERE clauses as array with associative keys (which can be used to overwrite 'delete' or 'pidList') or a single one as string.
	 ...
	 *
	 * @param	array		$rowSource The source record data. Needs uid and pidf to be set.
	...
	/**
	 * Update the satus of a meta data record
	 *
