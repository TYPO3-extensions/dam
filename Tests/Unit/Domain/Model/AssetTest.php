...
/**
 * Test case for class Tx_Dam_Domain_Model_Asset.
 *
 * @version $Id$
 ...
 */
class Tx_Dam_Domain_Model_AssetTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_Dam_Domain_Model_Asset
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_Dam_Domain_Model_Asset();
	}
	 ...
	 * @test
	 */
	public function getFalReturnsInitialValueForTx_Dam_Domain_Model_File() { 
		$this->assertEquals(
			NULL,
			$this->fixture->getFal()
		);
	 ...
	 * @test
	 */
	public function setFalForTx_Dam_Domain_Model_FileSetsFal() { 
		$dummyObject = new Tx_Dam_Domain_Model_File();
