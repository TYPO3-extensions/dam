...
class tx_dam_base_config_testcase extends tx_dam_testlib {
	...
	public function test_config_setValue () {
		...
		$value = tx_dam::config_getValue('setup.indexing.auto', true);
		$wanted = array('disable' => true);
		self::assertEquals ($value, $wanted);
	}
...
//if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/dam/tests/tx_dam_base_config_testcase.php'])	{
//	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/dam/tests/tx_dam_base_config_testcase.php']);
//}
?>