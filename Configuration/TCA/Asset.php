...
$TCA['tx_dam_domain_model_asset'] = array(
	...
	'types' => array(
		...
		'1' => array('showitem' => 'asset_type, file, thumbnail, l10n_parent, title, description, alternative, caption, keywords, identifier,
									...
									--div--;LLL:EXT:dam/Resources/Private/Language/locallang_db.xml:tabs.language, sys_language_uid, l10n_diffsource, language,
									...
									--div--;LLL:EXT:dam/Resources/Private/Language/locallang_db.xml:tabs.temporalInfo, creation_date, modification_date,
									--div--;LLL:EXT:dam/Resources/Private/Language/locallang_db.xml:tabs.file, download_name,
		...
		'2' => array('showitem' => 'asset_type, file, l10n_parent, title, description, alternative, caption, keywords, identifier,
									--div--;LLL:EXT:dam/Resources/Private/Language/locallang_db.xml:tabs.visibility, hidden, status, ranking,
									--div--;LLL:EXT:dam/Resources/Private/Language/locallang_db.xml:tabs.language, sys_language_uid, l10n_diffsource,
									--div--;LLL:EXT:dam/Resources/Private/Language/locallang_db.xml:tabs.metrics, color_space, --palette--;;10;;, --palette--;;14;;,
									--div--;LLL:EXT:dam/Resources/Private/Language/locallang_db.xml:tabs.copyright, creator, publisher, source,
