 ...
 *
 * $Id: class.browse_links.php,v 1.1.2.2 2006/03/08 21:36:20 ingmars Exp $
...
class browse_links {
	...
	function init()	{
		...
		$this->setTitle = $this->curUrlArray['title'];
			...
			// this is ugly but the other classes like localPageTree in this files expect the values in $GLOBALS['SOBE']
		$GLOBALS['SOBE']->act = $this->act;
		$GLOBALS['SOBE']->mode = $this->mode;
		$GLOBALS['SOBE']->bparams = $this->bparams;
		$GLOBALS['SOBE']->mode = $this->mode;
		$GLOBALS['SOBE']->curUrlInfo = $this->curUrlInfo;
...
// Include extension?
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/dam/compat/class.browse_links.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/dam/compat/class.browse_links.php']);
}
